...
../bin/configtxgen -profile ${CHANNEL_TWO_PROFILE} -outputAnchorPeersUpdate ./channel-artifacts/Org3MSPanchors_${CHANNEL_TWO_PROFILE}.tx -channelID $CHANNEL_TWO_PROFILE -asOrg Org3MSP
