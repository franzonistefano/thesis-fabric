...
contract BoxPoints {
    ...
    function getEvaluatedRequest(uint _evaluatedIndex) public view returns(address, uint, uint, uint, uint, bool, uint) {
        ...
        return (pendingBox[_evaluatedIndex].userAddress, pendingBox[_evaluatedIndex].tshirt, pendingBox[_evaluatedIndex].pants, pendingBox[_evaluatedIndex].jacket, pendingBox[_evaluatedIndex].other, pendingBox[_evaluatedIndex].isEvaluated, pendingBox[_evaluatedIndex].points);
    }
