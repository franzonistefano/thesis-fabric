...
export FAB3_CHANNEL=channel12 # Channel to be used for the transactions
export FAB3_CCID=evmcc # ID of the EVM Chaincode deployed in your fabric network
export FAB3_PORT=5001 # Port the proxy will listen on. If not provided default is 5000.
